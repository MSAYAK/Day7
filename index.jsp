		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="student">New Student Registration</a></li>
					<li><a href="institutes">Institute Registration</a></li>
					<li><a href="login">Login Student</a><li>
				</ul>
	...
	<div class="container-fluid">
				...
				<div class="list-group">
					<marquee onmouseover="stop()" onmouseout="start()" direction="up"
						...
						<p>
							...
							Pradesh has been extended up to <strong>15th December 2019</strong>
						</p>
					</marquee>
				</div>
			</div>
		...
		<div class="col-sm-3">
			...
			<div class="panel panel-default">
				...
				<a href="#"> <img class="img-responsive"
							src="resources/images/images.jpg" alt="">
						</a>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="btn-group" role="group">
						...
						<br> <a href="officerlogin"><button type="button"
								class="btn btn-default">State</button></a><br> <br>
								 <a href="MinistryLogin"><button type="button"
